...
import com.theskysid.backend.jwt.JwtService;
...
import com.theskysid.backend.repository.PatientRepository;
import com.theskysid.backend.repository.PractitionerRepository;
import com.theskysid.backend.repository.UserRepository;
import com.theskysid.backend.util.CookieUtil;
    ...
    public ResponseEntity<AuthResponseDTO> register(RegisterRequestDTO registerRequestDTO) {
        ...
        switch (registerRequestDTO.getRole()) {
            case PATIENT -> {
                ...
                patient.setHealthRecordUrl(registerRequestDTO.getHealthRecordUrl());
                patient.setPhoneNumber(registerRequestDTO.getPhoneNumber());
            ...
            case PRACTITIONER -> {
                ...
                practitioner.setLicenseNumber(registerRequestDTO.getLicenseNumber());
                practitioner.setConsultationFee(registerRequestDTO.getConsultationFee());
                practitioner.setAvailable(registerRequestDTO.getAvailable() != null ? registerRequestDTO.getAvailable() : Boolean.TRUE);
